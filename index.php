        ...
        <div id="page-content">
            ...
            <div class="slideshow slideshow-wrapper pb-section">
                <div class="home-slideshow">
                    ...
                    <div class="slide">
                        <div class="blur-up lazyload">
                            <img class="blur-up lazyload" data-src="assets/images/slideshow-banners/home5-banner1.jpg" src="assets/images/slideshow-banners/home5-banner1.jpg" alt="Shop New Collection" title="Shop New Collection" />
                            <div class="slideshow__text-wrap slideshow__overlay classic middle">
                                <div class="slideshow__text-content middle">
                                    <div class="container">
                    ...
                    <div class="productSlider-style2 grid-products">
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout-1.html" class="grid-view-item__link">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload" data-src="assets/images/cosmetic-products/product-image3.jpg" src="assets/images/cosmetic-products/product-image3.jpg" alt="image" title="product">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload" data-src="assets/images/cosmetic-products/product-image3-1.jpg" src="assets/images/cosmetic-products/product-image3-1.jpg" alt="image" title="product">
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
            ...
            <div class="section">
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="section-header text-center">
                                <h2 class="h2 heading-font">Feature Jewellery</h2>
                                <p>Jewellery is the next best thing to Love!</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="section hero hero--medium hero__overlay bg-size">
                <img class="bg-img" src="assets/images/parallax-banners/cosmetic-parallax.jpg" alt="" />
