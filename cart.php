...
<!-- belle/cart.php   11 Nov 2019 12:47:01 GMT -->
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-8 col-lg-8 main-col">
                        <form action="#" method="post" class="cart style2">
                            <table>
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="3" class="text-left"><a href="shop.php" class="btn  cart-continue"><i class="icon icon-arrow-circle-left"></i> Continue shopping</a></td>
                    ...
                    <div class="col-12 col-sm-12 col-md-4 col-lg-4 cart__footer">
                        ...
                        <div class="solid-border">
                            ...
                            <a style="margin-top: 20px;" href="checkout.php" class="btn btn--small-wide checkout">Go for checkout</a>
